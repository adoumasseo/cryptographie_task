...
char *encode(unsigned int gap, unsigned int a, char *_str, char *alphabet)
{
	char *newstr;
	char *encode;
...
void main(void)
{
	...
	str[strcspn(str, "\n")] = '\0';
	new = encode(gap, a, str, "abcdefghijklmnopqrstuvwxyz");
